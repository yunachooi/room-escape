...
--RESERVATION 
INSERT INTO RESERVATION (RESV_ID, NUM_PEOPLE, REQUEST_MSG, RESV_DATE, MEMBER_ID, SCHEDULE_ID)
VALUES (resv_id_seq.nextval, 3, '처음이라 초급으로', TO_DATE('2025-06-01', 'YYYY-MM-DD'), 'user01', 1);

INSERT INTO RESERVATION (RESV_ID, NUM_PEOPLE, REQUEST_MSG, RESV_DATE, MEMBER_ID, SCHEDULE_ID)
VALUES (resv_id_seq.nextval, 4, '', TO_DATE('2025-06-02', 'YYYY-MM-DD'), 'user01', 1);

INSERT INTO RESERVATION (RESV_ID, NUM_PEOPLE, REQUEST_MSG, RESV_DATE, MEMBER_ID, SCHEDULE_ID)
VALUES (resv_id_seq.nextval, 2, '공포테마 좋아함', TO_DATE('2025-06-03', 'YYYY-MM-DD'), 'user01', 2);

INSERT INTO RESERVATION (RESV_ID, NUM_PEOPLE, REQUEST_MSG, RESV_DATE, MEMBER_ID, SCHEDULE_ID)
VALUES (resv_id_seq.nextval, 3, '생일 기념이에요!', TO_DATE('2025-06-04', 'YYYY-MM-DD'), 'user01', 2);

INSERT INTO RESERVATION (RESV_ID, NUM_PEOPLE, REQUEST_MSG, RESV_DATE, MEMBER_ID, SCHEDULE_ID)
VALUES (resv_id_seq.nextval, 2, '', TO_DATE('2025-06-05', 'YYYY-MM-DD'), 'user01', 3);

INSERT INTO RESERVATION (RESV_ID, NUM_PEOPLE, REQUEST_MSG, RESV_DATE, MEMBER_ID, SCHEDULE_ID)
VALUES (resv_id_seq.nextval, 4, '단체 할인 적용해주세요', TO_DATE('2025-06-06', 'YYYY-MM-DD'), 'user01', 3);

INSERT INTO RESERVATION (RESV_ID, NUM_PEOPLE, REQUEST_MSG, RESV_DATE, MEMBER_ID, SCHEDULE_ID)
VALUES (resv_id_seq.nextval, 3, '기대하고 있어요!', TO_DATE('2025-06-07', 'YYYY-MM-DD'), 'user01', 4);

INSERT INTO RESERVATION (RESV_ID, NUM_PEOPLE, REQUEST_MSG, RESV_DATE, MEMBER_ID, SCHEDULE_ID)
VALUES (resv_id_seq.nextval, 2, '공포 말고 추리 테마 원해요', TO_DATE('2025-06-08', 'YYYY-MM-DD'), 'user01', 4);

INSERT INTO RESERVATION (RESV_ID, NUM_PEOPLE, REQUEST_MSG, RESV_DATE, MEMBER_ID, SCHEDULE_ID)
VALUES (resv_id_seq.nextval, 4, '', TO_DATE('2025-06-09', 'YYYY-MM-DD'), 'user01', 5);

INSERT INTO RESERVATION (RESV_ID, NUM_PEOPLE, REQUEST_MSG, RESV_DATE, MEMBER_ID, SCHEDULE_ID)
VALUES (resv_id_seq.nextval, 2, '소규모로 조용히 즐기고 싶어요', TO_DATE('2025-06-10', 'YYYY-MM-DD'), 'user01', 5);

INSERT INTO RESERVATION (RESV_ID, NUM_PEOPLE, REQUEST_MSG, RESV_DATE, MEMBER_ID, SCHEDULE_ID)
VALUES (resv_id_seq.nextval, 3, '추리 좋아합니다', TO_DATE('2025-06-11', 'YYYY-MM-DD'), 'user01', 6);

INSERT INTO RESERVATION (RESV_ID, NUM_PEOPLE, REQUEST_MSG, RESV_DATE, MEMBER_ID, SCHEDULE_ID)
VALUES (resv_id_seq.nextval, 4, '', TO_DATE('2025-06-12', 'YYYY-MM-DD'), 'user01', 6);
